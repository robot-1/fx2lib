...
class fx2 {
    ...
    public:
        ...
        int do_usb_command(unsigned char* buf, unsigned char type, unsigned char request, unsigned short value, unsigned short index, unsigned short length, int timeout = 1000 );
